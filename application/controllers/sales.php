...
class Sales extends Secure_area
{
	...
	function complete()
	{
		...
		//Start Mine
			...
			$data['type'] = 'customer';
			$data['due_ammount'] = $data['amount_due'];
			$data['paid_ammount'] = $data['total'] - $data['amount_due'];
			if($this->due->check($customer_id,'customer') == false){
				$this->due->insert($data);
			}else{
				$ammount = $this->due->check($customer_id,'customer');
