...
<head>
	...
	<meta http-equiv="content-type" content="text/html; charset=utf-8" />
	<title>HUB P.O.S <?php echo $this->lang->line('login_login'); ?></title>
...
<body>
	...
	<div id="login">
		<h1><img width="220px" src=<?php echo base_url();?>/images/logo.gif></h1>
	...
	<?php echo form_close(); ?><h1>Hub IT P.O.S. <?php echo $this->config->item('application_version'); ?></h1>
</body>
</html>
